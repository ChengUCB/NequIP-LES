...
| [extended_les_fit](https://github.com/ChengUCB/extended_les_fit) | maintained production configs for the published models |
...
With `run: [train, test]` this trains and then writes predictions including BECs. To run BEC
