...
follow the NequIP framework, so this documentation only covers what is specific to LES and
links to the `NequIP docs <https://nequip.readthedocs.io>`_ for everything else.
