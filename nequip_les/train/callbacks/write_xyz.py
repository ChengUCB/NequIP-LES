...
# This file is adopted from the NequIP package. (https://github.com/djkim-kr/nequip/blob/main/nequip/train/callbacks/write_xyz.py)
import torch
import lightning
    ...
    def on_test_batch_end(
        ...
        with torch.no_grad():
            ...
            if AtomicDataDict.LATENT_CHARGE_KEY in output_out:
                ...
                output_out["latent_q"] = latent_charge_flat
                register_fields(node_fields=["latent_q"])
                self.extra_fields.append("latent_q")
